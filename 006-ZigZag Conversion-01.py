...
class Solution(object):
    def convert(self, s, numRows):
        ...
        ##给原始字符串的每个字符标注行数，其实就是一个123...(n-1)n(n-1)...32123...的一个序列，也就是每个字符的行数和前一个字符的行数一定是+1或者-1的关系。
        ##这样我们通过arr[line]，然后把所有arr[1],arr[2],arr[3]...arr[n-1],arr[n]用join函数串成一个字符串，就好了。
        ...
        ##在上面一个循环里，假如s = "PAYPALISHIRING",numRow=4的话，循环的产生顺序也就是arr[0] == 'P',然后arr[1] == 'A',然后arrp[2] == 'Y'
